...
public class SortingImpl implements Sorting {
     ...
     */
    @Override
    public <T extends Comparable> void sort(ArrayList<T> elements, SortingType sortingType) {
    ...
    private  <T extends Comparable> void sortAscending(ArrayList<T> elements) {
    ...
    public <T extends Comparable> void sortDescending(ArrayList<T> elements) {
